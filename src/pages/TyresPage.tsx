    ...
    <div className="py-12">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Wide selection of tyres for quads and crosscarts for all kinds of
          tracks and surfaces. Most popular models are available in stock.
          Special orders are delivered within a week from the Netherlands.
                ...
                <div className="mt-4 flex flex-col">
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="flex items-center text-xs text-gray-600 font-medium">
                      ...
                      <span>
                        {tyre.type.charAt(0).toUpperCase() + tyre.type.slice(1)}{" "}
                      </span>
                    </div>
                  ...
                  <div className="mt-4">
                    <Link
                      to={`/contact?inquiry=tyre&name=${encodeURIComponent(
                        tyre.name
                      )}`}
        ...
        {!loading && !error && tyres.length === 0 && (
          <div className="my-16 text-center">
            <p className="text-lg text-gray-500">
              No tyres found in this category.
            </p>
          </div>
        )}
      </div>
